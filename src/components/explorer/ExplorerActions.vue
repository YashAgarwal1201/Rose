...
const { activate, deactivate } = useFocusTrap(fabContainerRef, { escapeDeactivates: false, returnFocusOnDeactivate: false, fallbackFocus: () => fabContainerRef.value || document.body });
