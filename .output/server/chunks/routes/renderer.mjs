...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/logo.svg"},{"rel":"apple-touch-icon","href":"/logo.svg"}],"style":[],"script":[],"noscript":[],"title":"Project Rose","charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
